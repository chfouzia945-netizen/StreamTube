...
async function initDB() {
  if (usePostgres()) {
    ...
    await pool.query(
      "CREATE TABLE IF NOT EXISTS streamtube_state (id integer PRIMARY KEY, data jsonb NOT NULL, updated_at timestamptz NOT NULL DEFAULT now())"
    );
